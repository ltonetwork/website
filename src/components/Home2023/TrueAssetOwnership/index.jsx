    ...
    return (
        <section id="home--TrueAssetOwnership" className="section-2023 pt-100">
          <div className="container">
           ...
           <p>Our <span style={{ color:"#00FFFF" }}>2025</span> RWA Roadmap is here. We have revealed the world&apos;s most advanced ecosystem for RWAs, bringing true decentralized ownership for real-world assets to the digital space.</p>
            ...
            <Link href="https://blog.ltonetwork.com/2025-roadmap/" target="_blank">
              <a className="link-2023 mt-50">2025 RWA ROADMAP</a>
            </Link>
          </div>
        </section>
    );
