          ...
          <div className="row">
            <div className="col-lg-6">
              <div className="vid-area">
                ...
                <br/>
                  <p>
                  With NFT2.0, TITANIUM will empower content creators worldwide, 
such as artists, musicians, game developers (and more) to develop,
build and expand their own worlds.
